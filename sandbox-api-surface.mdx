...
`sandbox.rigbox.dev` is built on top of the same Rigbox API base (`https://api.rigbox.dev/api/v1`). It provides a streamlined UI for running AI-generated code in isolated Firecracker micro-VMs with terminal access, app management, and log streaming.
