...
In managed mode, the workspace does not hold provider API keys in the VM. Instead it sends requests to the internal proxy URL (`AI_PROXY_URL`, default `http://172.16.0.1:9090`).
