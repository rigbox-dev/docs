...
description: "A small TypeScript/Hono service gives you a complete first deployment without application credentials."
---
...
[Open the quickstart source](https://github.com/rigbox-dev/rigbox-examples/tree/2612ffc9138d3b2f8169b10e3a54abd5495db8b8/quickstart). These manifests explicitly select **incremental** deployment.
...
The local source is uploaded from this directory. The commented Git source is an alternative configuration, not required for this tutorial.
...
Open the URL reported by deployment and request `/healthz`. Change the welcome text in the local source and deploy again; verify the page changes while the workspace ID remains the same.

## Access and recovery

The example does not declare public visibility. Use the authenticated Rigbox route; set visibility deliberately before sharing it.
