...
<CodeGroup>
```bash cURL
curl -X POST https://api.rigbox.dev/api/v1/workspaces/$WORKSPACE_ID/tools/architecture-explorer/install \
...
response = requests.post(
    f"https://api.rigbox.dev/api/v1/workspaces/{workspace_id}/tools/architecture-explorer/install",
...
```bash cURL
while true; do
  STATUS=$(curl -s https://api.rigbox.dev/api/v1/workspaces/$WORKSPACE_ID/tools/architecture-explorer/install-status \
...
while True:
    resp = requests.get(
        f"https://api.rigbox.dev/api/v1/workspaces/{workspace_id}/tools/architecture-explorer/install-status",
        headers={"Authorization": f"Bearer {api_key}"},
    )
...
<CodeGroup>
```bash cURL
curl -X POST https://api.rigbox.dev/api/v1/workspaces/$WORKSPACE_ID/tools/architecture-explorer/launch \
  -H "Authorization: Bearer $RIGBOX_API_KEY"
```

```python Python
response = requests.post(
    f"https://api.rigbox.dev/api/v1/workspaces/{workspace_id}/tools/architecture-explorer/launch",
    headers={"Authorization": f"Bearer {api_key}"},
)
...
<CodeGroup>
```bash cURL
curl -X POST https://api.rigbox.dev/api/v1/workspaces/$WORKSPACE_ID/tools/architecture-explorer/stop \
  -H "Authorization: Bearer $RIGBOX_API_KEY"
```

```python Python
requests.post(
    f"https://api.rigbox.dev/api/v1/workspaces/{workspace_id}/tools/architecture-explorer/stop",
    headers={"Authorization": f"Bearer {api_key}"},
)
