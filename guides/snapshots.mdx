...
response = requests.post(
    f"https://api.rigbox.dev/api/workspaces/{workspace_id}/snapshots",
    headers={"Authorization": f"Bearer {token}"},
...
// Stop the workspace
await fetch(
  `https://api.rigbox.dev/api/workspaces/${workspaceId}/stop`,
  {
    method: "POST",
...
const response = await fetch(
  `https://api.rigbox.dev/api/workspaces/${workspaceId}/snapshots`,
  {
    method: "POST",
    headers: {
...
# Workspace must be stopped
response = requests.post(
    f"https://api.rigbox.dev/api/workspaces/{workspace_id}/snapshots/{snapshot_id}/restore",
    headers={"Authorization": f"Bearer {token}"}
)
...
// Workspace must be stopped
const response = await fetch(
  `https://api.rigbox.dev/api/workspaces/${workspaceId}/snapshots/${snapshotId}/restore`,
  {
    method: "POST",
    headers: { "Authorization": `Bearer ${token}` },
  }
