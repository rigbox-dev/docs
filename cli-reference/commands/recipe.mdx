...
title: "rig recipe"
sidebarTitle: "recipe"
description: "Publish and install community recipes"
---
...
```text
Usage: rigbox recipe [OPTIONS] <COMMAND>
```
...
```text
Publish and install community recipes

Usage: rigbox recipe [OPTIONS] <COMMAND>

Commands:
  app   Per-app recipes for installing into existing workspaces
...
- [app](/cli-reference/commands/recipe/app)
