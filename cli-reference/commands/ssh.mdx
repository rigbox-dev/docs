...
title: "rig ssh"
sidebarTitle: "ssh"
description: "Manage SSH public keys for your account"
---
...
```text
Usage: rigbox ssh [OPTIONS] <COMMAND>
```
...
Commands:
  ls    List registered SSH public keys
  add   Register a new SSH public key
  rm    Remove a registered SSH public key
  sync  Push your SSH keys into a workspace
...
- [add](/cli-reference/commands/ssh/add)
- [ls](/cli-reference/commands/ssh/ls)
- [rm](/cli-reference/commands/ssh/rm)
- [sync](/cli-reference/commands/ssh/sync)
