...
title: "rig build ls"
sidebarTitle: "ls"
description: "List your recent image builds (including failed ones)"
---
...
| --- | --- | --- |
| `--limit` | Max builds to show | Value: LIMIT; Default: 50 |
...
```text
List your recent image builds (including failed ones)
