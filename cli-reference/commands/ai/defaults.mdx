---
title: "rig ai defaults"
sidebarTitle: "defaults"
description: "Update account-level AI defaults"
---
...
```bash
rig ai defaults --help
```

## Local syntax

```text
Usage: rigbox ai defaults [OPTIONS]
```
...
| --- | --- | --- |
| `-p, --provider` | Default provider: google, openai, or anthropic | Value: PROVIDER |
| `-m, --model` | Default model id (e.g. claude-sonnet-4-20250514) | Value: MODEL |
| `--mode` | Default AI mode: managed or byok | Value: MODE; Choices: managed, byok |
...
Options:
  ...
  -p, --provider <PROVIDER>
          Default provider: google, openai, or anthropic
  ...
  -m, --model <MODEL>
      ...
      --mode <MODE>
          Default AI mode: managed or byok
