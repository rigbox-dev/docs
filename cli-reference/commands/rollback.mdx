...
description: "Reverse a preview promotion, or activate a specific release"
---
...
```bash
rig rollback --workspace WORKSPACE_ID
```
...
```text
Usage: rigbox rollback [OPTIONS] --workspace <WORKSPACE>
```
...
| `--release` | Activate this release instead of reversing the last preview promotion | Value: RELEASE |
...
```text
Reverse a preview promotion, or activate a specific release
...
Options:
  ...
  -w, --workspace <WORKSPACE>
      ...
      --release <RELEASE>
          Activate this release instead of reversing the last preview promotion
