---
title: "rig service-spec"
sidebarTitle: "service-spec"
description: "Manage account-level service specs"
---
...
```bash
rig service-spec --help
```

## Local syntax

```text
Usage: rigbox service-spec [OPTIONS] <COMMAND>
```
...
```text
Manage account-level service specs

Usage: rigbox service-spec [OPTIONS] <COMMAND>

Commands:
  ls      List your service specs
  create  Create a new service spec from a YAML file
  update  Update an existing service spec from a YAML file
  rm      Delete a service spec
...
- [create](/cli-reference/commands/service-spec/create)
- [ls](/cli-reference/commands/service-spec/ls)
- [rm](/cli-reference/commands/service-spec/rm)
- [update](/cli-reference/commands/service-spec/update)
