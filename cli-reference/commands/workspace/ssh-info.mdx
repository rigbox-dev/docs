---
title: "rig workspace ssh-info"
sidebarTitle: "ssh-info"
description: "Print SSH connection info for a workspace"
---
...
```bash
rig workspace ssh-info --help
```

## Local syntax

```text
Usage: rigbox workspace ssh-info [OPTIONS] --workspace <WORKSPACE>
```
...
```text
Print SSH connection info for a workspace
...
```text
Usage: rigbox workspace ssh-info [OPTIONS]
```
...
```text
Print this workspace's SSH connection info
