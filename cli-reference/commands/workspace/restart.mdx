...
```bash
rig workspace restart --workspace WORKSPACE_ID
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig workspace restart --help
```

## Local syntax

```text
Usage: rigbox workspace restart [OPTIONS] --workspace <WORKSPACE>
```
