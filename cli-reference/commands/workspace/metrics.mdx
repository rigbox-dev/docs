---
title: "rig workspace metrics"
sidebarTitle: "metrics"
description: "Show live CPU, RAM, and disk metrics"
---
...
```bash
rig workspace metrics --help
```

## Local syntax

```text
Usage: rigbox workspace metrics [OPTIONS] --workspace <WORKSPACE>
```
...
```text
Show live CPU, RAM, and disk metrics
