---
title: "rig workspace env unset"
sidebarTitle: "unset"
description: "Unset one or more environment variables on a workspace"
---
...
```bash
rig workspace env unset KEYS --workspace WORKSPACE_ID
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig workspace env unset --help
```

## Local syntax

```text
Usage: rigbox workspace env unset [OPTIONS] --workspace <WORKSPACE> <KEYS>...
```
...
| --- | --- | --- |
| `keys` | Variable names to clear (one or more) | Required; Value: KEYS |
...
```text
Unset one or more environment variables on a workspace

Usage: rigbox workspace env unset [OPTIONS] --workspace <WORKSPACE> <KEYS>...

Arguments:
  <KEYS>...
          Variable names to clear (one or more)
...
```text
Usage: rigbox workspace env unset [OPTIONS] <KEYS>...
```
