---
title: "rig workspace env get"
sidebarTitle: "get"
description: "Print workspace environment variables"
---
...
```bash
rig workspace env get --workspace WORKSPACE_ID
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig workspace env get --help
```

## Local syntax

```text
Usage: rigbox workspace env get [OPTIONS] --workspace <WORKSPACE> [KEY]
```
...
| --- | --- | --- |
| `key` | Single key to fetch (default: print all) | Value: KEY |
...
```text
Print workspace environment variables

Usage: rigbox workspace env get [OPTIONS] --workspace <WORKSPACE> [KEY]

Arguments:
  [KEY]
          Single key to fetch (default: print all)
...
```text
Usage: rigbox workspace env get [OPTIONS] [KEY]
```
...
```text
Print env vars (pass a key for a single var)
