...
```bash
rig workspace rm --help
```

## Local syntax

```text
Usage: rigbox workspace rm [OPTIONS] --workspace <WORKSPACE>
```
...
| `-f, --force` | Skip the deletion prompt | Default: false |
