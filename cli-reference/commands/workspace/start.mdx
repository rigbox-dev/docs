...
```bash
rig workspace start --help
```

## Local syntax

```text
Usage: rigbox workspace start [OPTIONS] --workspace <WORKSPACE>
```
...
| `--wait-for-apps` | Wait until workspace apps become active | Default: false |
...
Options:
  ...
  -w, --workspace <WORKSPACE>
      ...
      --wait-for-apps
          Wait until workspace apps become active
