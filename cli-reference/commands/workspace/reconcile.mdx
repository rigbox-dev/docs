---
title: "rig workspace reconcile"
sidebarTitle: "reconcile"
description: "Reconcile workspace apps with the template"
---
...
```bash
rig workspace reconcile --workspace WORKSPACE_ID
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig workspace reconcile --help
```

## Local syntax

```text
Usage: rigbox workspace reconcile [OPTIONS] --workspace <WORKSPACE>
```
...
```text
Reconcile workspace apps with the template
