---
title: "rig workspace services"
sidebarTitle: "services"
description: "List background services tracked in the workspace"
---
...
```bash
rig workspace services --workspace WORKSPACE_ID
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig workspace services --help
```

## Local syntax

```text
Usage: rigbox workspace services [OPTIONS] --workspace <WORKSPACE>
```
...
```text
List background services tracked in the workspace
