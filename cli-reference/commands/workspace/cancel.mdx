---
title: "rig workspace cancel"
sidebarTitle: "cancel"
description: "Cancel an in-progress workspace creation"
---
...
```bash
rig workspace cancel --workspace WORKSPACE_ID
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig workspace cancel --help
```

## Local syntax

```text
Usage: rigbox workspace cancel [OPTIONS] --workspace <WORKSPACE>
```
...
```text
Cancel an in-progress workspace creation
