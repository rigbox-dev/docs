---
title: "rig workspace ai mode"
sidebarTitle: "mode"
description: "Set the workspace AI mode"
---
...
```bash
rig workspace ai mode managed --workspace WORKSPACE_ID
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig workspace ai mode --help
```

## Local syntax

```text
Usage: rigbox workspace ai mode [OPTIONS] --workspace <WORKSPACE> <MODE>
```
...
| --- | --- | --- |
| `mode` | AI mode: managed or byok | Required; Value: MODE; Choices: managed, byok |
...
```text
Set the workspace AI mode

Usage: rigbox workspace ai mode [OPTIONS] --workspace <WORKSPACE> <MODE>

Arguments:
  <MODE>
          AI mode: managed or byok
          
          [possible values: managed, byok]
...
```text
Usage: rigbox workspace ai mode [OPTIONS] <MODE>
```
