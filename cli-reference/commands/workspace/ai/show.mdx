---
title: "rig workspace ai show"
sidebarTitle: "show"
description: "Show AI config for a workspace"
---
...
```bash
rig workspace ai show --workspace WORKSPACE_ID
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig workspace ai show --help
```

## Local syntax

```text
Usage: rigbox workspace ai show [OPTIONS] --workspace <WORKSPACE>
```
...
```text
Show AI config for a workspace
...
```text
Usage: rigbox workspace ai show [OPTIONS]
```
...
```text
Show AI config for this workspace
