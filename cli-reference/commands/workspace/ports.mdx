---
title: "rig workspace ports"
sidebarTitle: "ports"
description: "List ports the workspace is currently listening on"
---
...
```bash
rig workspace ports --workspace WORKSPACE_ID
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig workspace ports --help
```

## Local syntax

```text
Usage: rigbox workspace ports [OPTIONS] --workspace <WORKSPACE>
```
...
```text
List ports the workspace is currently listening on
