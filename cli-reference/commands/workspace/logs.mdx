---
title: "rig workspace logs"
sidebarTitle: "logs"
description: "View workspace logs"
---
...
```bash
rig workspace logs --help
```

## Local syntax

```text
Usage: rigbox workspace logs [OPTIONS] --workspace <WORKSPACE>
```
...
```text
Usage: rigbox workspace logs [OPTIONS]
```
