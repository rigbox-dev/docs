---
title: "rig workspace ai"
sidebarTitle: "ai"
description: "Manage workspace AI configuration"
---
...
```bash
rig workspace ai --help
```

## Local syntax

```text
Usage: rigbox workspace ai [OPTIONS] <COMMAND>
```
...
```text
Manage workspace AI configuration

Usage: rigbox workspace ai [OPTIONS] <COMMAND>

Commands:
  mode  Set the workspace AI mode
  show  Show AI config for a workspace
...
Commands:
  mode  Set the workspace AI mode
  show  Show AI config for this workspace
  help  Print this message or the help of the given subcommand(s)
...
- [mode](/cli-reference/commands/workspace/ai/mode)
- [show](/cli-reference/commands/workspace/ai/show)
