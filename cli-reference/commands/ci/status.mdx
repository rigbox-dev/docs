...
title: "rig ci status"
sidebarTitle: "status"
description: "Show repository bindings and their pending or active state"
---
...
```text
Usage: rigbox ci status [OPTIONS]
```
...
| --- | --- | --- |
| `--repo` | Filter by GitHub owner/repository | Value: REPO |
...
```text
Show repository bindings and their pending or active state
...
Options:
      ...
      --repo <REPO>
          Filter by GitHub owner/repository
