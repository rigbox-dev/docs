...
title: "rig ci unlink"
sidebarTitle: "unlink"
description: "Remove a repository binding and revoke its deploy credentials"
---
...
```text
Usage: rigbox ci unlink [OPTIONS] --repo <REPO>
```
...
| `--workspace` | Target workspace name or id; required when a repository has multiple bindings | Value: WORKSPACE |
...
```text
Remove a repository binding and revoke its deploy credentials
...
Options:
      ...
      --workspace <WORKSPACE>
          Target workspace name or id; required when a repository has multiple bindings
