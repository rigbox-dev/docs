---
title: "rig recipe app yank"
sidebarTitle: "yank"
description: "Yank a published recipe version"
---
...
```bash
rig recipe app yank --ref DEPLOY_REF
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig recipe app yank --help
```

## Local syntax

```text
Usage: rigbox recipe app yank [OPTIONS] --ref <DEPLOY_REF>
```
...
```text
Yank a published recipe version
