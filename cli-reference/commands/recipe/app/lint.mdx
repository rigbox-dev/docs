---
title: "rig recipe app lint"
sidebarTitle: "lint"
description: "Validate a rig.yaml against the canonical schema"
---
...
```bash
rig recipe app lint --help
```

## Local syntax

```text
Usage: rigbox recipe app lint [OPTIONS] [MANIFEST]
```
...
```text
Validate a rig.yaml against the canonical schema
