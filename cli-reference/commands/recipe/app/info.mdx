---
title: "rig recipe app info"
sidebarTitle: "info"
description: "Show a manifest summary or deploy preview"
---
...
```bash
rig recipe app info --help
```

## Local syntax

```text
Usage: rigbox recipe app info [OPTIONS] [TARGET]
```
...
| --- | --- | --- |
| `target` | Local manifest path or exact deploy ref | Value: TARGET; Default: rig.yaml |
...
```text
Show a manifest summary or deploy preview

Usage: rigbox recipe app info [OPTIONS] [TARGET]

Arguments:
  [TARGET]
          Local manifest path or exact deploy ref
