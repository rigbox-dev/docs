---
title: "rig recipe app health"
sidebarTitle: "health"
description: "Show aggregate community registry health"
---
...
```bash
rig recipe app health --help
```

## Local syntax

```text
Usage: rigbox recipe app health [OPTIONS]
```
...
```text
Show aggregate community registry health
