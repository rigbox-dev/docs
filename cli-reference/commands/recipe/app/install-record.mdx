---
title: "rig recipe app install-record"
sidebarTitle: "install-record"
description: "Show the community install record for an installed app"
---
...
```bash
rig recipe app install-record --app APP_ID
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig recipe app install-record --help
```

## Local syntax

```text
Usage: rigbox recipe app install-record [OPTIONS] --app <APP>
```
...
```text
Show the community install record for an installed app
