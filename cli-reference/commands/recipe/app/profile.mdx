---
title: "rig recipe app profile"
sidebarTitle: "profile"
description: "Show or update your community recipe profile"
---
...
| --- | --- | --- |
| `--username` | Claim or update your community vendor username | Value: USERNAME |
| `--preference` | Community-items preference: disabled, verified_only, or enabled | Value: PREFERENCE |
...
```text
Show or update your community recipe profile
...
Options:
      ...
      --username <USERNAME>
          Claim or update your community vendor username

      --preference <PREFERENCE>
          Community-items preference: disabled, verified_only, or enabled
