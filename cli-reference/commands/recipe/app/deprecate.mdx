---
title: "rig recipe app deprecate"
sidebarTitle: "deprecate"
description: "Deprecate a published recipe version"
---
...
```bash
rig recipe app deprecate --ref DEPLOY_REF
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig recipe app deprecate --help
```

## Local syntax

```text
Usage: rigbox recipe app deprecate [OPTIONS] --ref <DEPLOY_REF>
```
...
| --- | --- | --- |
| `-r, --ref` | Exact recipe ref, e.g. @vendor/slug@1.2.3 | Required; Value: DEPLOY_REF |
...
```text
Deprecate a published recipe version
...
Options:
  ...
  -r, --ref <DEPLOY_REF>
          Exact recipe ref, e.g. @vendor/slug@1.2.3
