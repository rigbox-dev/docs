---
title: "rig release activate"
sidebarTitle: "activate"
description: "Activate a release for a workspace"
---
...
```bash
rig release activate --workspace WORKSPACE_ID --release RELEASE_ID
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig release activate --help
```

## Local syntax

```text
Usage: rigbox release activate [OPTIONS] --workspace <WORKSPACE> --release <RELEASE>
```
...
| `--release` | Release id (from `rig release ls`) | Required; Value: RELEASE |
...
```text
Activate a release for a workspace
...
Options:
  ...
  -w, --workspace <WORKSPACE>
      ...
      --release <RELEASE>
          Release id (from `rig release ls`)
