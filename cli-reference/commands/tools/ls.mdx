...
title: "rig tools ls"
sidebarTitle: "ls"
description: "List tools running in a workspace"
---
...
```bash
rig tools ls --workspace WORKSPACE_ID
```
...
```text
Usage: rigbox tools ls [OPTIONS] --workspace <WORKSPACE>
```
...
```text
List tools running in a workspace
