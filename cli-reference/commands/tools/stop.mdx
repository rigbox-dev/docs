---
title: "rig tools stop"
sidebarTitle: "stop"
description: "Stop a tool"
---
...
```bash
rig tools stop --tool TOOL --workspace WORKSPACE_ID
```
...
```text
Usage: rigbox tools stop [OPTIONS] --tool <TOOL> --workspace <WORKSPACE>
```
