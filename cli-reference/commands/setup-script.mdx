---
title: "rig setup-script"
sidebarTitle: "setup-script"
description: "Manage reusable workspace setup scripts"
---
...
```bash
rig setup-script --help
```

## Local syntax

```text
Usage: rigbox setup-script [OPTIONS] <COMMAND>
```
...
```text
Manage reusable workspace setup scripts

Usage: rigbox setup-script [OPTIONS] <COMMAND>

Commands:
  ls      List your setup scripts
  create  Create a new setup script from a local file
  update  Update an existing setup script (--name and/or --file)
  rm      Delete a setup script
...
- [create](/cli-reference/commands/setup-script/create)
- [ls](/cli-reference/commands/setup-script/ls)
- [rm](/cli-reference/commands/setup-script/rm)
- [update](/cli-reference/commands/setup-script/update)
