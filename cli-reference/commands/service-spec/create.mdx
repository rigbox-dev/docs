---
title: "rig service-spec create"
sidebarTitle: "create"
description: "Create a new service spec from a YAML file"
---
...
```bash
rig service-spec create --file ./config.json
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig service-spec create --help
```

## Local syntax

```text
Usage: rigbox service-spec create [OPTIONS] --file <FILE>
```
...
```text
Create a new service spec from a YAML file
