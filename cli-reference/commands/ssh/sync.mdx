...
title: "rig ssh sync"
sidebarTitle: "sync"
description: "Push your SSH keys into a workspace"
---
...
```text
Usage: rigbox ssh sync [OPTIONS] --workspace <WORKSPACE>
```
...
| --- | --- | --- |
| `-w, --workspace` | Target workspace name or id | Required; Value: WORKSPACE |
...
```text
Push your SSH keys into a workspace
