---
title: "rig app param ls"
sidebarTitle: "ls"
description: "List all declared parameters and their current values"
---
...
```bash
rig app param ls --help
```

## Local syntax

```text
Usage: rigbox app param ls [OPTIONS] --app <APP>
```
...
```text
List all declared parameters and their current values
