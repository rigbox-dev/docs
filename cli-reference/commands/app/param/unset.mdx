---
title: "rig app param unset"
sidebarTitle: "unset"
description: "Reset parameters to their defaults"
---
...
```bash
rig app param unset --app APP_ID KEYS
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig app param unset --help
```

## Local syntax

```text
Usage: rigbox app param unset [OPTIONS] --app <APP> <KEY>...
```
...
| `keys` | One or more keys to clear (positional, repeatable) | Required; Value: KEY |
...
Arguments:
  <KEY>...
          One or more keys to clear (positional, repeatable)
