---
title: "rig app verify-domain"
sidebarTitle: "verify-domain"
description: "Re-check DNS for an app custom domain"
---
...
```text
Re-check DNS for an app custom domain
