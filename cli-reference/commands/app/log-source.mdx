---
title: "rig app log-source"
sidebarTitle: "log-source"
description: "Manage app log sources"
---
...
```bash
rig app log-source --help
```

## Local syntax

```text
Usage: rigbox app log-source [OPTIONS] <COMMAND>
```
...
```text
Manage app log sources

Usage: rigbox app log-source [OPTIONS] <COMMAND>

Commands:
  ls      List log sources for an app
  add     Add a log source to an app
  update  Update an app log source
  rm      Remove an app log source
...
- [add](/cli-reference/commands/app/log-source/add)
- [ls](/cli-reference/commands/app/log-source/ls)
- [rm](/cli-reference/commands/app/log-source/rm)
- [update](/cli-reference/commands/app/log-source/update)
