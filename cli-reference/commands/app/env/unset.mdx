---
title: "rig app env unset"
sidebarTitle: "unset"
description: "Unset app environment variables (restart the app to apply)"
---
...
| --- | --- | --- |
| `-a, --app` | App name, id, or exact subdomain | Required; Value: APP |
| `keys` | Environment variable names to remove | Required; Value: KEYS |
...
```text
Unset app environment variables (restart the app to apply)
...
Options:
  -a, --app <APP>
          App name, id, or exact subdomain
