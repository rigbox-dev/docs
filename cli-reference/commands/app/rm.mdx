...
```text
Usage: rigbox app rm [OPTIONS] --app <APP>
```
...
| `-w, --workspace` | Workspace to narrow app name matches | Value: WORKSPACE |
| `--force` | Confirm deletion of system-managed apps | Default: false |
| `--force-delete` | Confirm deletion of apps containing user-modifiable files | Default: false |
...
Options:
  ...
  -w, --workspace <WORKSPACE>
          Workspace to narrow app name matches

      --cli-input-json <FILE>
          Read inputs from a JSON file or '-' (stdin)

      --force
          Confirm deletion of system-managed apps

      --cli-input-yaml <FILE>
          Read inputs from a YAML file or '-' (stdin)

      --force-delete
          Confirm deletion of apps containing user-modifiable files
