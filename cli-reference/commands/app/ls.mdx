...
title: "rig app ls"
sidebarTitle: "ls"
description: "List apps in a workspace (or all your workspaces)"
---
...
Inside a workspace, list installed apps.
...
| --- | --- | --- |
| `-w, --workspace` | Workspace name or id (default: all your workspaces) | Value: WORKSPACE |
...
```text
List apps in a workspace (or all your workspaces)
...
Options:
  ...
  -w, --workspace <WORKSPACE>
          Workspace name or id (default: all your workspaces)
