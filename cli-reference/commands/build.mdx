...
title: "rig build"
sidebarTitle: "build"
description: "Build reproducible images and view build logs"
---
...
```text
Usage: rigbox build [OPTIONS] <COMMAND>
```
...
```text
Build reproducible images and view build logs

Usage: rigbox build [OPTIONS] <COMMAND>

Commands:
  image  Build a reproducible image for a workspace
  logs   View host build logs for a build (the builder's install output)
  ls     List your recent image builds (including failed ones)
...
- [image](/cli-reference/commands/build/image)
- [logs](/cli-reference/commands/build/logs)
- [ls](/cli-reference/commands/build/ls)
