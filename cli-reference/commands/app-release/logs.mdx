---
title: "rig app-release logs"
sidebarTitle: "logs"
description: "Read app release logs"
---
...
```bash
rig app-release logs --workspace WORKSPACE_ID --release RELEASE_ID
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig app-release logs --help
```

## Local syntax

```text
Usage: rigbox app-release logs [OPTIONS] --workspace <WORKSPACE> --release <RELEASE>
```
...
| `--release` | Retained app release ID | Required; Value: RELEASE |
