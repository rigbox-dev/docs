---
title: "rig app-release activate"
sidebarTitle: "activate"
description: "Activate a ready app release staged with deploy --sync-only"
---
...
```bash
rig app-release activate --workspace WORKSPACE_ID --release RELEASE_ID
```

Inspect the supported arguments before running this command. Help is offline and does not modify resources.

```bash
rig app-release activate --help
```

## Local syntax

```text
Usage: rigbox app-release activate [OPTIONS] --workspace <WORKSPACE> --release <RELEASE>
```
...
| `--release` | Ready app release ID | Required; Value: RELEASE |
...
```text
Activate a ready app release staged with deploy --sync-only
