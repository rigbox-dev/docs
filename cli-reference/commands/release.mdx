...
description: "Manage workspace releases"
---
...
```text
Usage: rigbox release [OPTIONS] <COMMAND>
```
...
```text
Manage workspace releases

Usage: rigbox release [OPTIONS] <COMMAND>

Commands:
  create    Create a release pinning an image digest
  ls        List releases for a workspace
  activate  Activate a release for a workspace
...
- [activate](/cli-reference/commands/release/activate)
- [create](/cli-reference/commands/release/create)
- [ls](/cli-reference/commands/release/ls)
